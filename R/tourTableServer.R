...
#' @TODO(fred) if launched in a empty page (no inputs, buttons or tour groups), check if (js) tourGetMembers() send a NULL or a (named) list of length 0. In first case, this wil leads to infinite loop.
#' 
